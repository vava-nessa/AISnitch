...
- [ ] [01 — Commander CLI](./01_cli-daemon_commands.md) — Setup commander + commandes start/stop/status
- [ ] [02 — Daemon Mode](./02_cli-daemon_daemon-mode.md) — Foreground default + `--daemon` + `attach`
